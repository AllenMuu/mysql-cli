...
- **支持**:claude / codex / cursor / opencode / copilot / codebuddy / trae / pi。Codex 无 `ask` 决策,采用 Rules 粗门 prompt + PermissionRequest hook 精过滤(只读自动放行、写保持原生审批、fail-to-prompt),边界见 `docs/agent-integration.md` 的 Codex 特殊说明。
